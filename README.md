...
For every wrong letter the user completes the image of the hung man with an indication to how many lives remain.
Once the user chooses the correct letter, no life is lost, and they can continue on to the next letter with the correctly guessed letter displayed in its location within the world. 
